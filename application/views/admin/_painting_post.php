            ...
            <div class="grid_8">
                <div class="module">
                     ...
                     <div class="module-body">
                        <form action="<?php echo site_url($_com.'painting_post/edit/'.$special)?>" method="post">
                ...
                <div class="module">
                    ...
                    <div class="module-body">
                        <p>
                            ...
                            <a onclick="return confirm_click();" class="button" href="<?=site_url($_com.'painting_post/clone_to_top/'.$post->id)?>"><span>Move post to top</span></a>                            
                        </p>
                    </div> <!-- End .module-body -->
