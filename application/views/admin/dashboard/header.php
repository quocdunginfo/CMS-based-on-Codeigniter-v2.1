...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <div id="header">
                ...
                <div class="container_12">
                    <div class="grid_12">
                        <div id="logo">
                            <ul id="nav">
                                <script>
                                function view_sub_menu(sender,div_id)
                                {
                                    $('.'+'subnav').hide();
                                    $('#'+div_id).show();
                                }
                                ...
                                <li <?php if($this->uri->segment(1)=='admin_category') echo 'id="current"'; ?>><a href="<?php echo site_url('admin_category'); ?>" onmouseover="view_sub_menu(this,'subnav_category')">Categories</a></li>
                                <li <?php if($this->uri->segment(1)=='admin_posts' || $this->uri->segment(1)=='admin_post') echo 'id="current"'; ?>><a href="<?php echo site_url('admin_posts'); ?>" onmouseover="view_sub_menu(this,'subnav_post')">Posts</a></li>
            ...
            <!-- Sub navigation -->
            <!-- for admin_category --> 
            <div class="subnav" id="subnav_category" style="display: none;">
                <div class="container_12">
                    <div class="grid_12">
                        <ul>
            ...
            <!-- Sub navigation -->
            <!-- for admin_posts --> 
            <div class="subnav" id="subnav_post" style="display: none;">
                <div class="container_12">
                    <div class="grid_12">
                        <ul>
