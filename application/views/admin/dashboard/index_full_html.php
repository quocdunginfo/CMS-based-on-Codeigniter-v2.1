	...
	<body>
                    ...
                    <div class="grid_12">
                        <div id="logo">
                            <ul id="nav">
                                ...
                                <li <?php if($this->uri->segment(1)=='admin_user') echo 'id="current"'; ?>><a href="<?php echo site_url('admin_user'); ?>">Users</a></li>
		...
		<div class="container_12">
            ...
            <div class="grid_7">
                ...
                <a href="<?php echo site_url('admin_cat/new'); ?>" class="dashboard-module">
                ...
                <div class="module">
                    ...
                    <div class="module-table-body">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href=""><img src="src/pencil.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/pencil.gif" width="16" height="16" alt="edit" /></a>
                                        <a href=""><img src="src/balloon.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/balloon.gif" width="16" height="16" alt="comments" /></a>
                                        <a href=""><img src="src/bin.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/bin.gif" width="16" height="16" alt="delete" /></a>
                                    </td>
                                </tr>
                     ...
                     <div class="pagination">           
                		<a href="" class="button"><span><img src="src/arrow-stop-180-small.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/arrow-stop-180-small.gif" height="9" width="12" alt="First" /> First</span></a> 
                        <a href="" class="button"><span><img src="src/arrow-180-small.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/arrow-180-small.gif" height="9" width="12" alt="Previous" /> Prev</span></a>
                        <div class="numbers">
                            <span>Page:</span> 
                            <a href="">1</a> 
                            <span>|</span> 
                        ...
                        <a href="" class="button"><span>Next <img src="src/arrow-000-small.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/arrow-000-small.gif" height="9" width="12" alt="Next" /></span></a> 
                        <a href="" class="button last"><span>Last <img src="src/arrow-stop-000-small.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/arrow-stop-000-small.gif" height="9" width="12" alt="Last" /></span></a>
                        <div style="clear: both;"></div> 
                     </div>
