...
$upload_dir = '/ci/application/_static/upload/'; // path from base_url to base of upload folder
$current_path = '../../../../../../_static/upload/'; // relative path from filemanager folder to upload folder
...
$ext_file = array('doc', 'docx', 'pdf', 'xls', 'xlsx', 'txt', 'csv','html','psd','sql','log','fla','xml','ade','adp','ppt','pptx','zip','rar'); //Files
