...
<body>
<form id="slick-login" action="<?php echo site_url('admin/test_login');?>" method="post">
<p align="right" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#CCC; margin-bottom:5px; margin-top:10px; text-align:center; <?php if(in_array('',$state)) echo "visibility:hidden;" ?>">Invalid username or password!</p>
