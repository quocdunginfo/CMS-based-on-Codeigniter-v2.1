...
<div id="content" class="float_r">
    ...
    <table width="680px" cellspacing="0" cellpadding="5">
        <tbody>
            ...
            <tr>
                ...
                <td align="center">
                    <a href="<?=site_url($_com.'product/index/'.$item->get_product_obj()->id)?>">
                    <?=$item->get_product_obj()->title?>
                        </a>
                </td>
                
                <td align="center">
                    <form id="qd_form_0" action="<?=site_url($_com.'cart/add_or_update_from_cart')?>" method="post">
                ...
                <td align="center">
                    <a href="javascript:qd_confirm( '<?=site_url($_com.'cart/remove/painting_id/'.$item->get_product_obj()->id)?>' )">
    ...
    <div style="float: right;margin-right:10px; margin-top: 20px;">
        ...
        <p><a href="<?=site_url($_com.'cart/checkout')?>" class="mybutton" style="color:white;height:20px;width:120px;font-size:12px;font-weight:bold">Thanh toán</a></p></div>
